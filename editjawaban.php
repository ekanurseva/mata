...
<body>
  <div class="main-container d-flex">
    ...
    <div class="content" style="width: 100%;">
      <div class="container ">
        <h1 style="text-align:center; margin-top: 30px; color: white; padding: 0px 35px">EDIT JAWABAN</h1>
        <form action="" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="number" step="0.1" max="1" class="form-control" value="<?php echo $data['bobot']; ?>"
              name="bobot">
          </div>
          <button type="submit" name="submit_jawaban" class="btn btn-primary">Simpan</button>
        </form>
      </div>
    </div>
