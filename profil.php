  ...
  <div class="main-container d-flex">
    <div class="sidebar px-3 pt-3">
      <div class="header pb-3">
        <img class="text-center" src="img/<?= $user['foto']; ?>"
      ...
      <div class="container ">
        ...
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <div class="profil text-center mt-4">
            <img src="img/<?= $user['foto']; ?>" alt="" style="width:100px;">
            <div class="mb-3 mt-2 uploadFoto">
          ...
          <button type="submit" name="submit_profil" class="btn btn-primary">Simpan</button>
        </form>
      </div>
    </div>
