...
<body>
  <div class="main-container d-flex">
    ...
    <div class="content" style="width: 100%;">
      <div class="container ">
        <h1 style="text-align:center; margin-top: 30px; color: white; padding: 0px 35px">EDIT DATA PENGGUNA</h1>
        <form action="" method="post">
          ...
          <div class="mb-3 text-white">
            ...
            <select class="form-select" name="jk" aria-label="Default select example">
              <option value="<?= $data['jk']; ?>" selected hidden><?= $jk; ?></option>
          ...
          <div class="mb-3 text-white">
            ...
            <input type="password" name="password2" value="<?= $data['password']; ?>" class="form-control">
          </div>
          <div class="mb-3 text-white">
            <label class="form-label">Level</label>
            <select class="form-select" name="level" aria-label="Default select example">
              <option value="<?= $data['level']; ?>" selected hidden><?= $level; ?></option>
