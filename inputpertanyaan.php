...
<body>
  <div class="main-container d-flex">
    ...
    <div class="content" style="width: 100%;">
      <div class="container ">
        <h1 style="text-align:center; margin-top: 30px; color: white; padding: 0px 35px">INPUT PERTANYAAN</h1>
        <form>
          ...
          <button type="submit_pertanyaan" class="btn btn-primary mb-3">Simpan</button>
        </form>
      </div>
    </div>
